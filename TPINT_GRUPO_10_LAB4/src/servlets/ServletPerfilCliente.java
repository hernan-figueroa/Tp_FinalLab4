...
/**
 * Servlet implementation class ServletPerfilCliente
 */
...
public class ServletPerfilCliente extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("dopost:" + cliente);
		if(cliente!=null) {
		...
		out.println("<div class=\"row\">	<div class=\"row\">\r\n" + 
				...
				"		</div>\r\n" + 
				"		<div class=\"col-4\">\r\n" + 
				"			<input type=\"text\" class=\"form-control\" readonly value=\""+cliente.getDireccion()+"\">\r\n" + 
				"		</div>\r\n" + 
				"	</div>\r\n" + 
				"	<div class=\"row\">\r\n" + 
				"		<div class=\"col-4 p-2\">\r\n" + 
